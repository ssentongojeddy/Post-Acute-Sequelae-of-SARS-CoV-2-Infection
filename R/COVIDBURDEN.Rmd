...
```{r, message=F,echo=FALSE,fig.height=8, fig.width=6, echo=FALSE,warning=FALSE}
...
metabias(m1, method="linreg")# Egger P-value:p-value < 0.0001
metabias(m1, method="rank")# Begg P-value:p-value = 0.7986
```




# Plot figure 1: Overall point estimate = 55.59
...
```{r,fig.height=8.5, fig.width=6, echo=FALSE,warning=FALSE}
...
```{r,fig.height=10, fig.width=5, echo=FALSE,warning=FALSE}
...
```{r,fig.height=12.5, fig.width=6, echo=FALSE,warning=FALSE}
data=read.csv("AnalysisPASC3.csv")
l=reshape(data, 
...
# PULMONARY-------------------------------------
```{r,fig.height=14, fig.width=6, echo=FALSE,warning=FALSE, eval=T}
data=read.csv("AnalysisPASC3.csv")
...
```{r,fig.height=5.5, fig.width=6, echo=FALSE,warning=FALSE, eval=T}
data=read.csv("AnalysisPASC3.csv")
...
# Neuro-------------------------------------
```{r,fig.height=10.5, fig.width=6, echo=FALSE,warning=FALSE}
data=read.csv("AnalysisPASC3.csv")
l=reshape(data, 
...
# GI-------------------------------------
```{r,fig.height=5.5, fig.width=6, echo=FALSE,warning=FALSE}
data=read.csv("AnalysisPASC3.csv")
l=reshape(data, 
