...
ggsave("figs/Figure1b.pdf", width = 10, height = 10)
...
#pdf("figs/Figure3.pdf", width = 15, height = 22)
forest(m_neuro1,
...
m_GI1<- update(m_GI, byvar=Outcome,print.byvar=F)
#m_GI1
...
m_derm1<- update(m_derm, byvar=Outcome,print.byvar=F)
#m_derm1
...
m_ent1<- update(m_ent, byvar=Outcome,print.byvar=F)
#m_ent1
